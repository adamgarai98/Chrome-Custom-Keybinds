document.addEventListener('DOMContentLoaded', () => {
    ...
    // Loads keybinds from Chrome storage.
    ...
    // Saves keybinds to Chrome storage.
    const saveKeybinds = () => {
    ...
    const createIcon = (name) => {
        ...
        icon.setAttribute('stroke', '#1a1b26'); // Icon color
    ...
    // Renders the keybind configuration UI.
    const renderConfig = () => {
        ...
        Object.entries(keybinds).forEach(([key, url]) => {
            ...
            // Focus on URL input after key is entered.
            ...
            // Delete keybind on button click.
    ...
    // Adds a new empty keybind entry.
